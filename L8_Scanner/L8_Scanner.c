 ...
 * Function Prototypes
 ******************************************************************/
static void                  l8_scanner_app_init               ( void );
static wiced_bt_dev_status_t l8_scanner_management_callback    ( wiced_bt_management_evt_t event, wiced_bt_management_evt_data_t *p_event_data );
static void                  l8_scanner_set_advertisement_data ( void );
static void                  l8_scanner_advertisement_stopped  ( void );
static void                  l8_scanner_reset_device           ( void );
static uint32_t              hci_control_process_rx_cmd        ( uint8_t* p_data, uint32_t len );
#ifdef HCI_TRACE_OVER_TRANSPORT
static void                  l8_scanner_trace_callback         ( wiced_bt_hci_trace_type_t type, uint16_t length, uint8_t* p_data );
#endif
...
void application_start(void)
{
    ...
    wiced_bt_stack_init(l8_scanner_management_callback, &wiced_bt_cfg_settings, wiced_bt_cfg_buf_pools);
}
...
void newAdv(wiced_bt_ble_scan_results_t *p_scan_result, uint8_t *p_adv_data)
{
    ...
    // Iterate through each field in the Advertising packet
    uint8_t index=0;
...
/* Set Advertisement Data */
void l8_scanner_set_advertisement_data( void )
{
...
void l8_scanner_advertisement_stopped( void )
{
...
void l8_scanner_reset_device( void )
{
...
wiced_bt_dev_status_t l8_scanner_management_callback( wiced_bt_management_evt_t event, wiced_bt_management_evt_data_t *p_event_data )
{
    ...
    case BTM_ENABLED_EVT:
        ...
        wiced_bt_dev_register_hci_trace(l8_scanner_trace_callback);
#endif
...
#if 0
        if (l8_scanner_read_link_keys( &p_event_data->paired_device_link_keys_request ))
        {
    ...
    case BTM_BLE_ADVERT_STATE_CHANGED_EVT:
        ...
        {
            l8_scanner_advertisement_stopped();
        }
        break;
...
void l8_scanner_trace_callback( wiced_bt_hci_trace_type_t type, uint16_t length, uint8_t* p_data )
{
