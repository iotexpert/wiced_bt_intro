 ...
 * Function Prototypes
 ******************************************************************/
static void                  l7_advertising_app_init               ( void );
static wiced_bt_dev_status_t l7_advertising_management_callback    ( wiced_bt_management_evt_t event, wiced_bt_management_evt_data_t *p_event_data );
static void                  l7_advertising_set_advertisement_data ( void );
static void                  l7_advertising_advertisement_stopped  ( void );
static void                  l7_advertising_reset_device           ( void );
static uint32_t              hci_control_process_rx_cmd            ( uint8_t* p_data, uint32_t len );
#ifdef HCI_TRACE_OVER_TRANSPORT
static void                  l7_advertising_trace_callback         ( wiced_bt_hci_trace_type_t type, uint16_t length, uint8_t* p_data );
#endif
...
void application_start(void)
{
    ...
    wiced_bt_stack_init(l7_advertising_management_callback, &wiced_bt_cfg_settings, wiced_bt_cfg_buf_pools);
}

/*
 * This function is executed in the BTM_ENABLED_EVT management callback.
 */
void l7_advertising_app_init(void)
{
...
/* Set Advertisement Data */
void l7_advertising_set_advertisement_data( void )
{
...
void l7_advertising_advertisement_stopped( void )
{
...
void l7_advertising_reset_device( void )
{
...
wiced_bt_dev_status_t l7_advertising_management_callback( wiced_bt_management_evt_t event, wiced_bt_management_evt_data_t *p_event_data )
{
    ...
    case BTM_ENABLED_EVT:
        ...
        wiced_bt_dev_register_hci_trace(l7_advertising_trace_callback);
#endif
...
#if 0
        if (l7_advertising_read_link_keys( &p_event_data->paired_device_link_keys_request ))
        {
    ...
    case BTM_BLE_ADVERT_STATE_CHANGED_EVT:
        ...
        {
            l7_advertising_advertisement_stopped();
        }
        break;
...
void l7_advertising_trace_callback( wiced_bt_hci_trace_type_t type, uint16_t length, uint8_t* p_data )
{
